...
btn1.addEventListener("click", function (e) {
    ...
    localStorage.setItem("producto1", avena.nombre);
})
...
btn2.addEventListener("click", function (e) {
    ...
    localStorage.setItem("producto2", harina.nombre);
})
...
btn3.addEventListener("click", function (e) {
    ...
    localStorage.setItem("producto3", mascabo.nombre);
})
...
btn4.addEventListener("click", function (e) {
    ...
    localStorage.setItem("producto4", coco.nombre);
})
...
btn5.addEventListener("click", function (e) {
    ...
    localStorage.setItem("producto5", nueces.nombre);
})
...
btn6.addEventListener("click", function (e) {
    ...
    localStorage.setItem("producto6", almendras.nombre);
})
